/* FOLIUM v4 — components/sidebar.js
   Sidebar simples: apenas opção de Sair */
...
const Sidebar = {
  ...
  init() {
    ...
    /* Overlay escuro — SEM backdrop-filter para não borrar o conteúdo */
    ...
    panel.innerHTML = `
      ...
      <div class="sb-head">
        ...
        <button class="sb-close" onclick="Sidebar.close()" aria-label="Fechar">
          <svg viewBox="0 0 24 24" fill="none" stroke-width="2"
               ...
               style="width:18px;height:18px;stroke:var(--text-mid)">
      ...
      <div class="sb-user-block">
        <div class="sb-avatar">${first.charAt(0).toUpperCase()}</div>
        <div>
      ...
      <div class="sb-body">
        <button class="sb-logout-btn" onclick="Sidebar.close(); Router.logout()">
          <svg viewBox="0 0 24 24" fill="none" stroke-width="1.8"
               stroke-linecap="round" stroke-linejoin="round"
               style="width:18px;height:18px;stroke:currentColor;flex-shrink:0">
