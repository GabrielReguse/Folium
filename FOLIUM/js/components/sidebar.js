    ...
    panel.innerHTML = `
      ...
      <div class="sb-body">
        ...
        <div class="sb-theme-row">
          <span class="sb-theme-label">Aparência</span>
          <button class="sb-dark-toggle" onclick="App.toggleDarkMode()" type="button" title="Alternar modo escuro" aria-label="Alternar modo claro/escuro">
            <span class="sb-dm-sun"  style="display:${localStorage.getItem('folium-dark')==='1'?'none':'flex'}">
            ...
            <span class="sb-dm-moon" style="display:${localStorage.getItem('folium-dark')==='1'?'flex':'none'}">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="18" height="18">
